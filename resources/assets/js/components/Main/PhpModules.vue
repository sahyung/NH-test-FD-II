    ...
    <div class="container">
        ...
        <div class="col-md-3 col-sm-6">
          <ul class="php-modules-list">
            <li
              ...
              v-for="(module, idx) in sliceModule(list.phpModules, 1)"
            >
              {{ module }}
            </li>
          </ul>
        ...
        <div class="col-md-3 col-sm-6">
          <ul class="php-modules-list">
            <li
              :key="'module' + idx"
              class="php-modules-list__item"
              v-for="(module, idx) in sliceModule(list.phpModules, 2)"
            >
              {{ module }}
            </li>
          </ul>
        ...
        <div class="col-md-3 col-sm-6">
          <ul class="php-modules-list">
            <li
              :key="'module' + idx"
              class="php-modules-list__item"
              v-for="(module, idx) in sliceModule(list.phpModules, 3)"
            >
              {{ module }}
            </li>
          </ul>
        ...
        <div class="col-md-3 col-sm-6">
          <ul class="php-modules-list">
            <li
              :key="'module' + idx"
              class="php-modules-list__item"
              v-for="(module, idx) in sliceModule(list.phpModules, 4)"
            >
              {{ module }}
            </li>
          </ul>
      ...
      <div class="row m-top-20">
        <div class="col-md-12 text-center">
          <button type="button" class="btn btn-niaga btn-dark btn-bordered">
            Selengkapnya
          </button>
        </div>
      </div>
...
export default {
  ...
  methods: {
    getPhpModules() {
      axios.get('api/php-modules').then((resp) => {
        this.list.phpModules = resp.data;
      });
    },
